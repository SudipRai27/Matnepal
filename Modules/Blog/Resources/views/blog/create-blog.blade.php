...
@endif
<form action="{{route('create-blog-post')}}" method="POST" enctype="multipart/form-data" id="input-form">
...
<div class="form-group">
	...
	<option value="{{$index}}" {{ (Input::old("blog_category_id") == $index ? "selected":"") }}>{{$d}}</option>
	@endforeach
	</select>
</div>
<div class="form-group">
