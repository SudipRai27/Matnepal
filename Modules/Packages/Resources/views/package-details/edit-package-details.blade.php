...
<div class="nav-tabs-custom">            
    <ul class="nav nav-tabs">
      <li><h4>Edit Package Itinerary / Details</h4><br></li>     
...
<form action="{{route('edit-packages-details-post', $package_details->id)}}" method="POST" enctype="multipart/form-data" id="input-form">
...
<div class="row">	
	<div class="col-sm-6">	
		<div class="form-group">
			...
			<select name="package_id" class="form-control">
				...
				<option value="{{$d->id}}" @if($package_details->package_id == $d->id) selected @endif>{{$d->package_name}}</option>		
				@endforeach
			</select>
		</div>
	</div>		
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" name="country" class="form-control" placeholder = "Enter Country" value="{{$package_details->country}}">
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" name="duration" class="form-control" value="{{$package_details->duration}}" placeholder="Enter Duration">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<p style="color:red;">Altitude (*)</p>
			<input type="text" name="altitude" class="form-control" value="{{$package_details->altitude}}" placeholder="Enter Altitude">
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" name="trip_grade" class="form-control" value="{{$package_details->trip_grade}}" placeholder="Enter Trip Grade">
		</div>
	</div>
	<div class="col-sm-6">		
		<div class="form-group">
			<p style="color:red;">Group Size (*)</p>	
			<input type="text" class="form-control" name="group_size" value="{{$package_details->group_size}}" placeholder="Enter Group size ">
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="accomodation" value="{{$package_details->accomodation}}" placeholder="Enter Accomodation ">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
			<p style="color:red;">Best Season (*)</p>
			<input type="text" class="form-control" name="best_season" value="{{$package_details->best_season}}" placeholder="Enter Best Season ">
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="total_trip_cost" value="{{$package_details->total_trip_cost}}" placeholder="Enter Total Trip Cost ">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" name="discounted_price" class="form-control" placeholder="Enter Discounted Price" value="{{$package_details->discounted_price}}">
		</div>
	</div>
</div>
<div class="form-group">
	<p style="color:red;">Trip Overview (*)</p>
	<textarea class="form-control" name="trip_overview" rows="8" placeholder="Enter trip overview">{{$package_details->trip_overview}}</textarea>
</div>
<div class="form-group">
	<p style="color:red;">Brief Itinerary (*)</p>
	<textarea name ="brief_itinerary" class="form-control" rows = "7" cols = "140">{{ $package_details->brief_itinerary }}</textarea>
</div>
<div class="form-group">
	<p style="color:red;">Itinerary (*)</p>
	<textarea id = "editor1" name ="itinerary" class="form-control" rows = "7" cols = "140">{{ $package_details->itinerary }}</textarea>
</div>
<div class="form-group">
	Cost Inclusion<br>
	<textarea name="cost_inclusion" rows="5" placeholder="Place * if you want to display in list" class="form-control">{{$package_details->cost_inclusion}}</textarea>
</div>
<div class="form-group">
	Cost Exclusion<br>
	<textarea name="cost_exclusion" rows="5" placeholder="Place * if you want to display in list" class="form-control">{{$package_details->cost_exclusion}}</textarea>
</div>
...
<div class="form-group">
	...
	<div class="input_fields_wrap">
	    ...
	    <div class="row">
	    	...
	    	<div class="col-sm-3">
	       		<input type="text" name="start_date[]" class="form-control" placeholder="Enter Start Date" value="{{$dates->start_date}}">
	    	</div>
	    	<div class="col-sm-3">
	    		<input type="text" name="end_date[]" class="form-control" placeholder="Enter End Date" value="{{$dates->end_date}}">
	    	</div>
	    	<div class="col-sm-3">
	    		<input type="text" name="price[]" class="form-control" placeholder="Enter Price" value="{{$dates->price}}">
	    	</div>	   
	    	<div class="col-sm-3">
	    		<a href="{{route('delete-package-dates', $dates->id)}}" type="button" class="btn btn-danger">Delete</a>
	    	</div>
	    	<br>
	    	<br>
	    	@endforeach 	
...
<div class="form-group">
	...
	<div class="field_wrapper">
    	...
    	<div class="row">
	    	<div class="col-sm-4">
	       		<input type="text" name="no_of_people[]" placeholder="Enter no. of people" class="form-control" value="{{$discount->no_of_people}}" />	       
	    	</div>
	    	<div class="col-sm-4">
	    		<input type="text" name="discount_price[]" placeholder="Enter price" class="form-control" value="{{$discount->price}}" />
	    	</div>
	    	<div class="col-sm-4">
	    		<a href="{{ route('delete-package-group-discount', $discount->id)}}" type="button" class="btn btn-danger">Delete</a>
	    	</div>        	    	
   		</div>
   		<br>
   		@endforeach
   		<div>
	    	<button class="btn btn-success add_button" title="Add field">Add Discount Section &nbsp;<i class="glyphicon glyphicon-plus"></i></button>
	    </div>        
	</div>
</div>
@else
...
<div class="after-add-more">
	...
	<div class="row">
		...
		<div class="col-sm-5">
			<textarea name="question[]" class="form-control" placeholder="Enter Question Here" rows="4">{{$faq->question}}</textarea>
		</div>
		<div class="col-sm-6">
			<textarea name="answer[]" class="form-control" placeholder="Enter Answer Here" rows="4">{{$faq->answer}}</textarea>
		</div>	
		<div class="col-sm-1">
			<a href="{{ route('delete-package-faq', $faq->id) }}" type="button" class="btn btn-danger">Delete</a>
		</div>		
	</div>
	<br>
	@endforeach	
  	<div class="input-group-btn"> 
		<button class="btn btn-success add-more-button" type="button"><i class="glyphicon glyphicon-plus"></i> Add FAQ Section</button>
  	</div>
</div>
@else
...
<div class="row">
	...
	<br>
    <img src="{{URL::to('public/images/package_trip_map/', $package_details->trip_map)}}" height="100" width="100">
    @endif
	</div>
</div>
<br>
